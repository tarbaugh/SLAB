...
def _sandbox_context(
    ...
    *,
    ...
    lines = [
        ...
        "- Runs in here carry this job's id. If the operator cancels the job",
        "  from outside, those runs are failed for you. Do not cancel from",
        "  in here; there is no scancel.",
