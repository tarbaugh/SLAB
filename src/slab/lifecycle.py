...
def validate_transition(
    ...
    """Raise :class:`~slab.errors.IllegalTransitionError` unless the transition is permitted.
...
def validate_status_change(from_status: ExecutionStatus, to_status: ExecutionStatus) -> None:
    """Raise :class:`~slab.errors.IllegalStatusChangeError` unless the change is permitted.
