...
3. A provisional :class:`~foundation.models.TaskRecord` (status ``running``) is
   ...
   via ``Exception.add_note`` (see :func:`foundation.errors.failure_record`). The
...
from foundation.errors import SerializationError, failure_record
from foundation.lifecycle import ExecutionStatus
from foundation.models import TaskRecord, utcnow
from foundation.runtime import ActiveRun, current_run
